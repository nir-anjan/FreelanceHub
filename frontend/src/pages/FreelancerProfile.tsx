...
const mockFreelancers: Record<string, any> = {
  "1": {
    ...
    portfolio: [
      { id: 1, title: "E-commerce Platform", image: "https://images.unsplash.com/photo-1661956602116-aa6865609028?w=400" },
      { id: 2, title: "SaaS Dashboard", image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=400" },
      { id: 3, title: "Mobile Banking App", image: "https://images.unsplash.com/photo-1563986768609-322da13575f3?w=400" },
      { id: 4, title: "Healthcare Portal", image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=400" },
      { id: 5, title: "Social Media Platform", image: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=400" },
      { id: 6, title: "Real Estate Website", image: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=400" },
    ],
    reviews: [
      {
        id: 1,
        ...
        rating: 5,
        comment: "Sarah is an exceptional developer. She delivered our e-commerce platform ahead of schedule and the code quality is outstanding. Highly recommend!",
        date: "2 weeks ago"
      },
      {
        id: 2,
        ...
        rating: 5,
        comment: "Working with Sarah was a pleasure. She understood our requirements perfectly and provided valuable suggestions throughout the project.",
        date: "1 month ago"
      },
      {
        id: 3,
        ...
        rating: 4,
        comment: "Great communication and technical skills. The project was completed successfully with minor revisions needed.",
        date: "2 months ago"
      }
    ]
  },
  "2": {
    ...
    category: "Design",
    skills: ["UI/UX Design", "Figma", "Adobe XD", "Prototyping", "Brand Identity", "Design Systems"],
    ...
    portfolio: [
      { id: 1, title: "Mobile App Design", image: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=400" },
      { id: 2, title: "Brand Identity", image: "https://images.unsplash.com/photo-1626785774573-4b799315345d?w=400" },
      { id: 3, title: "Website Redesign", image: "https://images.unsplash.com/photo-1558655146-d09347e92766?w=400" },
    ],
    reviews: [
      {
        id: 1,
        ...
        rating: 5,
        comment: "Michael's design work exceeded our expectations. The UI is beautiful and our users love it!",
        date: "3 weeks ago"
      }
    ]
  }
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50/50 to-white">
      ...
      <main className="flex-grow">
        <div className="max-w-5xl mx-auto px-6 md:px-10 py-12">
          ...
          <Card>
            <CardContent className="p-6 md:p-8">
              <h2 className="text-2xl font-semibold text-foreground mb-6">Client Reviews</h2>
