...
class HttpClient {
  ...
  private async refreshTokenRequest(refreshToken: string): Promise<AxiosResponse<RefreshTokenResponse>> {
    return axios.post(`${this.axiosInstance.defaults.baseURL}/auth/token/refresh/`, {
